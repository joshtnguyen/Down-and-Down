...
public class SkillsRegistry
{
    ...
    public static void firstRun() {
        ...
        registry.Add(new Skills("Axe Swing", "Increases the user's CRIT RATE by 50% and CRIT DMG by 20% (+2.5% per stack) for 2 turns but be unable to move for 1 turn.", 2, 0, -1, "Self", "Walter"));
