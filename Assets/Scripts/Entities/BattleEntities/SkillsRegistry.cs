...
public class SkillsRegistry
{
    ...
    public static void firstRun() {
        ...
        registry.Add(new Skills("Heavy Slice", "Deals 150% (+8% per stack) of the player's attack on a single target.", 2, 0, -1, "Enemy", "Walter"));
        registry.Add(new Skills("Multi Slice", "Deals 80% of the player's attack on a single target. There is a base 150% (+15% per stack) chance of attacking again.", 2, 0, -1, "Enemy", "Walter"));
        registry.Add(new Skills("Axe Swing", "Increases the player's CRIT DMG by 20% (+2.5% per stack) for 2 turns but be unable to move for 1 turn.", 2, 0, -1, "Self", "Walter"));
        registry.Add(new Skills("Fist to the Face", "Deals 125% (+7% per stack) of the player's attack on a single target.", 2, 0, -1, "Enemy", "Benedict"));
        registry.Add(new Skills("Taunt", "Deals 125% (+7% per stack) of the player's attack on a single target.", 2, 0, -1, "Enemy", "Benedict"));
        ...
        registry.Add(new Skills("Cheer", "Increases all allies ATK by 8% (+2% per stack) for 2 turns.", 2, 0, -1, "Team", "Sherri"));
        ...
        registry.Add(new Skills("Energy Bar", "Heals an ally by 6% (+1.5% per stack) of the user's Max HP and increases SPD by 1 (+1 per stack).", 3, 0, -1, "Ally", "Jade"));
