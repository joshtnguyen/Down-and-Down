...
public class SkillsRegistry
{
    ...
    public static void firstRun() {
        ...
        registry_E.Add(new Skills("Hammer Down", "Decreases the target's DEF% by 10% (+2% per stack) for one turn and deals 150% (+8% per stack) of the user's attack.", 2, 0, -1, "Enemy", "Sledger"));
