...
public class SkillsRegistry
{
    ...
    public static void firstRun() {
        registry.Add(new Skills("Attack", "Deals 100% of the player's attack on a single target. Recovers 1 SP.", 0, -1, -1, "Enemy", null));
        ...
        registry.Add(new Skills("Multi Slice", "Deals 80% of the player's attack on a single target. There is a base 150% (+15% per stack) chance of attacking again.", 3, 0, -1, "Enemy", "Walter"));
