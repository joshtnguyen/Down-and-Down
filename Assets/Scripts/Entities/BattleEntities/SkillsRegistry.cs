...
public class SkillsRegistry
{
    ...
    public static void firstRun() {
        ...
        registry.Add(new Skills("Motivating Touch", "Increases an ally's ATK by 15% (+2.5% per stack) for 2 turns.", 2, 1, -1, "Ally", "Sherri"));
        registry.Add(new Skills("Cheer", "Increases all allies ATK by 8% (+2% per stack) for 2 turns.", 2, 1, -1, "Team", "Sherri"));
        registry.Add(new Skills("Protein Shake", "Increases one ally's CRIT DMG by 8% (+2% per stack) for 2 turns.", 2, 1, -1, "Ally", "Sherri"));
